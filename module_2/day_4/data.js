...
//   for (let i = 0; i < users.length; i++) {
//       const fullName = (users[i].first_name + " " + users[i].last_name).toLowerCase();

//       if (fullName.includes(keywordLower)) {
//           emails.push(users[i].email);
//       }
//   }

//   return emails.length > 0 ? emails : "Không tìm thấy email nào";
// }
// const keyword = "Aldie"
// console.log(findEmailsByKeyword(keyword));
// -Đếm số lượng user có age > 50.
// function countUsers() {
//   let countAgeAbove50 = 0;
//   for (let i = 0; i < users.length; i++) {
//       if (users[i].age > 50) {
//           countAgeAbove50++;
//       }
//   }
//   return countAgeAbove50;
// }
